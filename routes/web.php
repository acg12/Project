...
Route::get('/checkout', [TransactionController::class, 'checkout'])->middleware('security');
Route::get('/transactions', [TransactionController::class, 'viewTransactions'])->middleware('security');
